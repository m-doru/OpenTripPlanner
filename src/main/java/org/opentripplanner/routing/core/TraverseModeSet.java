...
public class TraverseModeSet implements Cloneable, Serializable {
    ...
    private static final int MODE_MISCELLANEOUS = 16384;

    private static final int MODE_TRANSIT = MODE_TRAM | MODE_RAIL | MODE_SUBWAY | MODE_FUNICULAR
            | MODE_GONDOLA | MODE_CABLE_CAR | MODE_BUS | MODE_FERRY | MODE_AIRPLANE | MODE_TAXI | MODE_MISCELLANEOUS;
    ...
    public boolean getTaxi(){ return (modes & MODE_TAXI) != 0; }

    public boolean getMiscellaneous(){ return (modes & MODE_MISCELLANEOUS) != 0; }
